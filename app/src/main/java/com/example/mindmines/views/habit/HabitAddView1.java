...
public class HabitAddView1 extends AppCompatActivity {
...
//        timePicker = findViewById(R.id.timePicker);
    ...
    protected void showAlert() {
        AlertDialog.Builder builder = new AlertDialog.Builder(HabitAddView1.this);
    ...
    protected void returnToHabitsView() {
        Intent myIntent = new Intent(HabitAddView1.this, HabitsView.class);
        HabitAddView1.this.startActivity(myIntent);
        finish();
    }
}